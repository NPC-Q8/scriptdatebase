--[ Lưu ý: Full Tiếng Việt nhưng sẽ không chính xác 100% ]
--[ Đổi Hub tên ở từ "tên script hub", ví dụ "Abc123 Hub" ]
--[ Editor xong thì Obfuscate. Có tiền thì nên sài Luarmor, Luraph. Không có tiền thì nên sài MoonSec V3 ]
--------------------------------------------------------------------------------------------------------------------------------------------
local v14 = loadstring(game:HttpGet("https://raw.githubusercontent.com/obfalchx/testfluent/refs/heads/main/FluentTrau"))();
local v15 = v14:CreateWindow({
    Title = "tên script hub",
    SubTitle = "by tên người làm",
    TabWidth = 160,
    Theme = "Dark",
    Acrylic = false,
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=id ảnh gắn vô";
v24.Parent = v23;
